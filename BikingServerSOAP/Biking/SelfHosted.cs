...
namespace System.ServiceModel
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Uri httpUrl = new Uri("http://localhost:8733/Design_Time_Addresses/Biking/MyBiking/");

            //Create ServiceHost
            ServiceHost host = new ServiceHost(typeof(MyBiking), httpUrl);
            ...
            host.AddServiceEndpoint(typeof(IMyBiking), binding, "");
